        ...
        */
        ...
        public static Boolean calcDamage(Obj_AI_Base targ)
        {
            ...
            else if (_Player.ChampionName == "Anivia")
            {
                ...
                if (checkCDtoCalc) { if (Program.R.IsReady()) { _Player.CalculateDamageOnUnit(targ, DamageType.Magical, (float)(new[] { 80, 120, 160 }[Program.Q.Level] + 0.25 * _Player.TotalMagicalDamage)); } } else { _Player.CalculateDamageOnUnit(targ, DamageType.Magical, (float)(new[] { 80, 120, 160 }[Program.Q.Level] + 0.25 * _Player.TotalMagicalDamage)); }
            }
